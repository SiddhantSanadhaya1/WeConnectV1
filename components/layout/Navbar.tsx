...
import { Network, BookOpen, ShoppingBag, LayoutDashboard, Menu, X, LogIn, LogOut, ShieldCheck } from "lucide-react";
...
export default function Navbar({ language = "en" }: { language?: Language }) {
  ...
  const links = baseLinks.filter((link) => {
    ...
    if (session?.role === "seller") return link.href === `/${language}/dashboard` || link.href === "/buyer-portal" || link.href === "/ecosystem";
    return true;
  });
